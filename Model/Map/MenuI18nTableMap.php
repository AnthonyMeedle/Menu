...
class MenuI18nTableMap extends TableMap
{
     ...
     */
    const DESCRIPTION = 'menu_i18n.DESCRIPTION';

    /**
     * the column name for the CHAPO field
     */
    const CHAPO = 'menu_i18n.CHAPO';

    /**
     * the column name for the POSTSCRIPTUM field
     */
    const POSTSCRIPTUM = 'menu_i18n.POSTSCRIPTUM';

    /**
     * the column name for the CREATED_AT field
     */
    const CREATED_AT = 'menu_i18n.CREATED_AT';

    /**
     * the column name for the UPDATED_AT field
     */
    const UPDATED_AT = 'menu_i18n.UPDATED_AT';

    /**
     * the column name for the VERSION field
     */
    const VERSION = 'menu_i18n.VERSION';

    /**
     * the column name for the VERSION_CREATED_AT field
     */
    const VERSION_CREATED_AT = 'menu_i18n.VERSION_CREATED_AT';

    /**
     * the column name for the VERSION_CREATED_BY field
     */
    const VERSION_CREATED_BY = 'menu_i18n.VERSION_CREATED_BY';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(MenuI18nTableMap::ID, MenuI18nTableMap::LOCALE, MenuI18nTableMap::TITLE, MenuI18nTableMap::DESCRIPTION, MenuI18nTableMap::CHAPO, MenuI18nTableMap::POSTSCRIPTUM, MenuI18nTableMap::CREATED_AT, MenuI18nTableMap::UPDATED_AT, MenuI18nTableMap::VERSION, MenuI18nTableMap::VERSION_CREATED_AT, MenuI18nTableMap::VERSION_CREATED_BY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(MenuI18nTableMap::ID => 0, MenuI18nTableMap::LOCALE => 1, MenuI18nTableMap::TITLE => 2, MenuI18nTableMap::DESCRIPTION => 3, MenuI18nTableMap::CHAPO => 4, MenuI18nTableMap::POSTSCRIPTUM => 5, MenuI18nTableMap::CREATED_AT => 6, MenuI18nTableMap::UPDATED_AT => 7, MenuI18nTableMap::VERSION => 8, MenuI18nTableMap::VERSION_CREATED_AT => 9, MenuI18nTableMap::VERSION_CREATED_BY => 10, ),
    ...
    {
        $this->addRelation('MenuI18nVersion', '\\Menu\\Model\\MenuI18nVersion', RelationMap::ONE_TO_MANY, array('id' => 'id', ), 'CASCADE', null, 'MenuI18nVersions');
    } // buildRelations()
    ...
    /**
     * Method to invalidate the instance pool of all tables related to menu_i18n     * by a foreign key with ON DELETE CASCADE
     */
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(MenuI18nTableMap::DESCRIPTION);
            $criteria->addSelectColumn(MenuI18nTableMap::CHAPO);
            $criteria->addSelectColumn(MenuI18nTableMap::POSTSCRIPTUM);
            $criteria->addSelectColumn(MenuI18nTableMap::CREATED_AT);
            $criteria->addSelectColumn(MenuI18nTableMap::UPDATED_AT);
            $criteria->addSelectColumn(MenuI18nTableMap::VERSION);
            $criteria->addSelectColumn(MenuI18nTableMap::VERSION_CREATED_AT);
            $criteria->addSelectColumn(MenuI18nTableMap::VERSION_CREATED_BY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(MenuI18nTableMap::ID, (array) $values, Criteria::IN);
        }
